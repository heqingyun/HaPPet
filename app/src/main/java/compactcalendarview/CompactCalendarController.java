...
import static compactcalendarview.CompactCalendarView.CompactCalendarViewListener;
import static compactcalendarview.CompactCalendarView.FILL_LARGE_INDICATOR;
import static compactcalendarview.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static compactcalendarview.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    void drawEvents(Canvas canvas, Calendar currentMonthToDrawCalender, int offset) {
        ...
        List<compactcalendarview.Events> uniqEvents = eventsContainer.getEventsForMonthAndYear(currentMonth, currentMonthToDrawCalender.get(Calendar.YEAR));
        ...
        if (uniqEvents != null) {
            for (int i = 0; i < uniqEvents.size(); i++) {
                compactcalendarview.Events events = uniqEvents.get(i);
