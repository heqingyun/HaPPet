...
class CollapsingAnimation extends Animation {
    ...
    private compactcalendarview.CompactCalendarView view;
    private int targetGrowRadius;
    private final boolean down;
    private compactcalendarview.CompactCalendarController compactCalendarController;

    public CollapsingAnimation(CompactCalendarView view, compactcalendarview.CompactCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
