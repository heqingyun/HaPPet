...
public class CompactCalendarView extends View {
    ...
    private final compactcalendarview.AnimationHandler animationHandler;
    ...
    public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new compactcalendarview.CompactCalendarController(new Paint(), new OverScroller(getContext()),
        ...
        animationHandler = new compactcalendarview.AnimationHandler(compactCalendarController, this);
    }
