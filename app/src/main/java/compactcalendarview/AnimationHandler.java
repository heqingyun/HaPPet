...
class AnimationHandler {
    ...
    private compactcalendarview.CompactCalendarController compactCalendarController;
    private CompactCalendarView compactCalendarView;
    private CompactCalendarView.CompactCalendarAnimationListener compactCalendarAnimationListener;

    AnimationHandler(compactcalendarview.CompactCalendarController compactCalendarController, CompactCalendarView compactCalendarView) {
    ...
    void openCalendar() {
        ...
        compactCalendarController.setAnimationStatus(compactcalendarview.CompactCalendarController.EXPAND_COLLAPSE_CALENDAR);
    ...
    private void setUpAnimationLisForExposeOpen(final Animator indicatorAnim, Animation heightAnim) {
        heightAnim.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                compactCalendarController.setAnimationStatus(compactcalendarview.CompactCalendarController.EXPOSE_CALENDAR_ANIMATION);
            }
        ...
        indicatorAnim.addListener(new AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                compactCalendarController.setAnimationStatus(compactcalendarview.CompactCalendarController.ANIMATE_INDICATORS);
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                compactCalendarController.setAnimationStatus(compactcalendarview.CompactCalendarController.IDLE);
                onOpen();
                isAnimating = false;
            }
        });
